...
#define DECLARE_VECTOR_INTERFACE(ELEM_TYPE, SUFFIX)                                                                 \
    ...
    ELEM_TYPE* get_mutable_elem_vector ## SUFFIX(VECTOR_TYPE(SUFFIX) *v, size_t index);                             \
    void set_elem_vector ## SUFFIX(VECTOR_TYPE(SUFFIX) *v, size_t index, ELEM_TYPE elem);                           \
    VECTOR_TYPE(SUFFIX) *add_element_vector ## SUFFIX(VECTOR_TYPE(SUFFIX) *v);                                      \
    ELEM_TYPE* mutable_back_vector ## SUFFIX(VECTOR_TYPE(SUFFIX) *v);
